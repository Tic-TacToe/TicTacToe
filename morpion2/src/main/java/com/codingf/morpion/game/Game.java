    ...
    public void reStart(){
        ...
        while (true) {
            ...
            if (answer.equals("n") || answer.equals("N")) {
                ...
                System.out.println("Vous pouvez quitter le jeu à tout moment en tapant le chiffre 9.");
                System.out.println("C'est le joueur X qui commence. Bonne chance!");
                System.out.println(" ");

                if (scoreO==1){
                    System.out.println("La dernière partie a été gagner par le joueur O");
                }else if (scoreX==1) {
                    System.out.println("La dernière partie a été gagner par le joueur X" );
                }else {
                    System.out.println("La dernière partie a été un match nul");
                }
                System.out.println();
                System.out.println("                             \n" +
                        "                             \n" +
